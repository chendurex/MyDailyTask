...
public abstract class TestSupport extends TestCase {
    ...
    protected void assertTextMessagesEqual(String message, Message[] firstSet, Message[] secondSet) throws JMSException {
        assertEquals("Message count does not match: " + message, firstSet.length, secondSet.length);
